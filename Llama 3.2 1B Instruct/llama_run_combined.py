...
# Quantization: Q4_K_M,
# Model Card: https://huggingface.co/bartowski/Llama-3.2-1B-Instruct-GGUF


INPUT_CSV  = "first1k.csv"
OUTPUT_CSV = "combined_with_model.csv"
LOG_FILE   = "llama_raw_log.txt"
...
with Path(LOG_FILE).open("w", encoding="utf8") as log_file:
    for index in range(len(data)):
        ...
        try:
            raw_reply = asking_llama(prompt_text)
...
print("LLama run time (sec):", round(elapsed_all, 1))
