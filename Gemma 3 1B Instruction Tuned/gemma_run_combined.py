...
MODEL_ID      = "gemma-3-1b-it-qat"  
# Model: lmstudio-community/gemma-3-1B-it-qat-GGUF, 
# Quantization: Q4_0,
# Model Card: https://huggingface.co/lmstudio-community/gemma-3-1b-it-GGUF


INPUT_CSV  = "first1k.csv"
OUTPUT_CSV = "combined_with_model.csv"
LOG_FILE   = "gemma_raw_log.txt"
...
with Path(LOG_FILE).open("w", encoding="utf8") as log_file:
    for index in range(len(data)):
        ...
        try:
            raw_reply = asking_gemma(prompt_text)
...
print("Gemma run time (sec):", round(elapsed_all, 1))
